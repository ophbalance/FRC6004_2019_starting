...
public class OI {
  ...
  public Joystick _game2 = new Joystick(1); 
  public Joystick _gamepad = new Joystick(0);
  //public Button upLift = new JoystickButton(opController, 5);
  public Button RunClimbUp = new JoystickButton(_game2, 3);
  ...
  public OI () {
    ...
    RunClimbUp.whileHeld(new climbup());
